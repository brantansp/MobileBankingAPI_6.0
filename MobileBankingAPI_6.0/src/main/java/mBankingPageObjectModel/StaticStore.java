...
public class StaticStore{
	...
	{
		System.out.println(mPassbookEmail());
	...
	public static String IFSCSearch()
	{
		...
		sb.append("{");
		  ...
		  sb.append("\"stat\": \""+prop.getProperty("state")+"\",");
	...
	public static String RTGS()
	{
		...
		sb.append("{");
		  ...
		  sb.append("\"eOpt\": \""+prop.getProperty("eOpt")+"\",");
		  sb.append("\"typ\": \""+prop.getProperty("typ")+"\",");
		  sb.append("\"benAccTyp\": \""+prop.getProperty("benAcc")+"\",");
		  sb.append("\"benAcc\": \""+prop.getProperty("benName")+"\",");
		  sb.append("\"benIfc\": \""+prop.getProperty("benIfc")+"\",");
		  sb.append("\"amt\": \""+prop.getProperty("amt")+"\",");
		  sb.append("\"rms\": \""+prop.getProperty("rms")+"\",");
		  sb.append("\"rtgspurpose\": \""+prop.getProperty("rtgspurpose")+"\"");
		  sb.append("},");
		  sb.append("\"footer\": {}");
	      sb.append("}");
	...
	public static String IMPSP2A()
	{
		...
		sb.append("{");
		  ...
		  sb.append("\"benAcc\": \""+prop.getProperty("benAcc")+"\",");
		  sb.append("\"benIfc\": \""+prop.getProperty("benIfc")+"\",");
		  sb.append("\"benAccTyp\": \""+prop.getProperty("benAccTyp")+"\",");
		  sb.append("\"amt\": \""+prop.getProperty("amt")+"\",");
	...
	public static String IMPSP2P()
	{
		...
		sb.append("{");
		  ...
		  sb.append("\"benMID\": \""+prop.getProperty("benMID")+"\",");
		  sb.append("\"txnFee\": \""+prop.getProperty("txnFee")+"\",");
		  sb.append("\"pChk\": \""+prop.getProperty("pChk")+"\",");
		  sb.append("\"ePn\": \""+prop.getProperty("ePn")+"\"");
		  sb.append("},");
	...
	public static String IMPSP2U(){
		...
		sb.append("{");
		  ...
		  sb.append("\"pChk\": \""+prop.getProperty("pChk")+"\",");
		  sb.append("\"ePn\": \""+prop.getProperty("ePn")+"\",");
		  sb.append("\"benAadhar\": \""+prop.getProperty("benAadhar")+"\",");
		  sb.append("\"benName\": \""+prop.getProperty("benName")+"\"");
		  sb.append("},");
		  sb.append("\"footer\": {}");
	      sb.append("}");
		...
		sb.append("{");
		  sb.append("\"header\": {");
		    ...
		    sb.append("\"servName\": \""+prop.getProperty("servName")+"\"");
				    sb.append("},");
			  sb.append("\"body\": {");
			  sb.append("\"templateName\": \""+prop.getProperty("templateName")+"\",");
			  sb.append("\"from\": \""+prop.getProperty("fDate")+"\",");
			  sb.append("\"to\": \""+prop.getProperty("tDate")+"\",");
			  sb.append("\"bcc\": \""+prop.getProperty("bcc")+"\",");
			  sb.append("\"subject\": \""+prop.getProperty("subject")+"\",");
			  sb.append("\"templateVal\": \""+prop.getProperty("templateVal")+"\",");
			  sb.append("\"uniqueRefNo\": \""+prop.getProperty("uniqueRefNo")+"\",");
			  sb.append("\"attachment\": [");
			  sb.append("\"emailAtchDesr\": \""+prop.getProperty("emailAtchDesr")+"\",");
			  sb.append("\"emailAtchName\": \""+prop.getProperty("emailAtchName")+"\",");
			  sb.append("\"emailAtchUrl\": \""+prop.getProperty("emailAtchUrl")+"\",");
			  sb.append("\"emailAtchPath\": \""+prop.getProperty("emailAtchPath")+"\"");
			  sb.append("] },");
			  sb.append("\"footer\": {");
		...
		sb.append("{");
		  ...
		  sb.append("\"mobNo\": \""+prop.getProperty("mobNo")+"\",");
		    ...
		    sb.append("},");
			  ...
			  sb.append("\"city\": \""+prop.getProperty("city")+"\",");
			  sb.append("\"tpy\": \""+prop.getProperty("tpy")+"\",");
			  sb.append("\"fromLat\": \""+prop.getProperty("fromLat")+"\",");
			  sb.append("\"fromLon\": \""+prop.getProperty("fromLon")+"\"");
			  sb.append(" },");
